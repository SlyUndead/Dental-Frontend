...
const DentalChart = ({ annotations, classCategories, confidenceLevels }) => {
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(16, 1fr)", gap: "2px" }}>
          {teeth
            ...
            .map((tooth) => (
              <div key={tooth.number} style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                <div style={{ fontSize: "10px", fontWeight: "500", marginBottom: "2px" }}>{tooth.number}</div>
          ...
          {teeth
            ...
            .map((tooth) => (
              <div key={tooth.number} style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <div style={{ fontSize: "10px", fontWeight: "500", marginTop: "2px" }}>{tooth.number}</div>
              </div>
            ))}
        </div>
